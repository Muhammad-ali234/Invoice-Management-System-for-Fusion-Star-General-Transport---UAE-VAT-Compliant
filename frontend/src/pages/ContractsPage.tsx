      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage rental contracts</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <div className="text-xl font-bold text-blue-600">{formatCurrency(totalMonthlyRevenue)}</div>
          </div>
        </div>
                  ...
                  <tr key={contract.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">Day {contract.billing_day} billing</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {contract.truck_plate ? `🚛 ${contract.truck_plate}` : 'No truck'}
                      </div>
